...
/** Maps a {@link WorkflowTask} of type {@code US_ADDRESS_LOOKUP} to a server-side system task. */
@Component
public class UsAddressLookupTaskMapper implements TaskMapper {

    public static final String TASK_TYPE = "US_ADDRESS_LOOKUP";

    private static final Logger LOGGER =
            LoggerFactory.getLogger(UsAddressLookupTaskMapper.class);

    private final ParametersUtils parametersUtils;
    private final MetadataDAO metadataDAO;

    @Autowired
    public UsAddressLookupTaskMapper(ParametersUtils parametersUtils, MetadataDAO metadataDAO) {
    ...
    public List<TaskModel> getMappedTasks(TaskMapperContext taskMapperContext)
        ...
        LOGGER.debug("TaskMapperContext {} in UsAddressLookupTaskMapper", taskMapperContext);
