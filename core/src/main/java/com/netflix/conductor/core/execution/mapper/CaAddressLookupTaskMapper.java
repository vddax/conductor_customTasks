...
/** Maps a {@link WorkflowTask} of type {@code CA_ADDRESS_LOOKUP} to a server-side system task. */
@Component
public class CaAddressLookupTaskMapper implements TaskMapper {

    public static final String TASK_TYPE = "CA_ADDRESS_LOOKUP";

    private static final Logger LOGGER =
            LoggerFactory.getLogger(CaAddressLookupTaskMapper.class);

    private final ParametersUtils parametersUtils;
    private final MetadataDAO metadataDAO;

    @Autowired
    public CaAddressLookupTaskMapper(ParametersUtils parametersUtils, MetadataDAO metadataDAO) {
    ...
    public List<TaskModel> getMappedTasks(TaskMapperContext taskMapperContext)
        ...
        LOGGER.debug("TaskMapperContext {} in CaAddressLookupTaskMapper", taskMapperContext);
