...
/**
 * Maps a {@link WorkflowTask} of type {@code EMAIL_HYGIENE} to a server-side system task {@link
 * TaskModel} of type {@code EMAIL_HYGIENE}.
 *
 * <p>Modeled after {@link HTTPTaskMapper}, but does not require a {@link TaskDef} to exist.
 */
@Component
public class EmailHygieneTaskMapper implements TaskMapper {

    public static final String TASK_TYPE = "EMAIL_HYGIENE";

    private static final Logger LOGGER = LoggerFactory.getLogger(EmailHygieneTaskMapper.class);

    private final ParametersUtils parametersUtils;
    private final MetadataDAO metadataDAO;

    @Autowired
    public EmailHygieneTaskMapper(ParametersUtils parametersUtils, MetadataDAO metadataDAO) {
    ...
    public List<TaskModel> getMappedTasks(TaskMapperContext taskMapperContext)
        ...
        LOGGER.debug("TaskMapperContext {} in EmailHygieneTaskMapper", taskMapperContext);
